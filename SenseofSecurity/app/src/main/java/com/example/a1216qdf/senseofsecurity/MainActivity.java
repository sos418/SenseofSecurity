...
import com.example.a1216qdf.senseofsecurity.intro.DefaultIntro;
...
//        AIzaSyACrHBx7b0nVOhvxv6nrjdSS-tLhlcgrQE
//        166101225734
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_GenderInformation) {
            GenderInfor();
...
//        Uri uri = Uri.parse(("tel:034638215"));
...
//        startActivity(intent);
        Intent intent = new Intent();
        intent.setClass(MainActivity.this, SafePhoneActivity.class);
        startActivity(intent);
    }
